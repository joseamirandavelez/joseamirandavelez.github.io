// Umami API settings
const API_TOKEN = 'api_ZIQ4GZsaiDOnfS3LIEbqniqFSaGuahTg'; // Replace with your Umami API token
const WEBSITE_ID = '7280d755-f756-4aca-b5ea-728e6e7340cc'; // Replace with your Umami website ID
